  ...
  public function submitPayment()
  {
    DB::transaction(function(){
      ...
      $payment = Payment::create([
        ...
        'tournament_id' => $this->request->tournament_id,
      ...
      $payload = [
        'transaction_details' => [
          'order_id'      => 'a'.$payment->id.$payment->user_id.$payment->team_id.$payment->tournament_id,
        ...
        'item_details' => [
          [
            ...
            'quantity' => 1,
            'name' => ucwords(str_replace('_', ' ', $payment->payment_type))
          ]
        ]
      ];
